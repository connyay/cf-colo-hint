...
impl Colo {
    ...
    pub const fn location_hint(&self) -> Option<LocationHint> {
        match self {
            ...
            Self::DXB => Some(LocationHint::EEur),
            ...
            Self::KJA => Some(LocationHint::Afr),
            Self::KMG => None,
            ...
            Self::ORF => None,
            Self::ORN => Some(LocationHint::EEur),
