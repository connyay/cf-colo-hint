...
impl Colo {
    ...
    pub const fn name(&self) -> &'static str {
        match self {
            ...
            Self::CVG => "Cincinnati, United States",
            ...
            Self::WLG => "Wellington, New Zealand",
    ...
    pub const fn location_hint(&self) -> Option<LocationHint> {
        match self {
            ...
            Self::ABJ => Some(LocationHint::Afr),
            ...
            Self::ALA => Some(LocationHint::Me),
            Self::ALG => Some(LocationHint::EEur),
            Self::AMD => Some(LocationHint::Apac),
            Self::AMM => Some(LocationHint::Afr),
            Self::AMS => Some(LocationHint::Afr),
            Self::ANC => Some(LocationHint::WNam),
            Self::ARI => None,
            Self::ARN => Some(LocationHint::Me),
            Self::ARU => Some(LocationHint::ENam),
            ...
            Self::BAQ => Some(LocationHint::Sam),
            Self::BBI => None,
            Self::BCN => Some(LocationHint::EEur),
            Self::BDQ => Some(LocationHint::Apac),
            Self::BEG => Some(LocationHint::EEur),
            Self::BEL => Some(LocationHint::ENam),
            Self::BEY => Some(LocationHint::WEur),
            ...
            Self::BWN => Some(LocationHint::Apac),
            Self::CAI => Some(LocationHint::Afr),
            Self::CAN => None,
            Self::CAW => Some(LocationHint::ENam),
            ...
            Self::CJB => None,
            Self::CKG => None,
            Self::CLE => Some(LocationHint::Sam),
            Self::CLO => Some(LocationHint::ENam),
            Self::CLT => Some(LocationHint::ENam),
            Self::CMB => Some(LocationHint::Apac),
            Self::CMH => Some(LocationHint::ENam),
            ...
            Self::CSX => None,
            Self::CTU => None,
            Self::CVG => Some(LocationHint::Sam),
            ...
            Self::DLA => Some(LocationHint::WEur),
            Self::DLC => None,
            Self::DLP => None,
            ...
            Self::DPS => None,
            Self::DTW => Some(LocationHint::Sam),
            Self::DUB => Some(LocationHint::Afr),
            Self::DUR => Some(LocationHint::WEur),
            Self::DUS => Some(LocationHint::Me),
            Self::DXB => Some(LocationHint::Apac),
            Self::DYU => Some(LocationHint::Me),
            Self::EBB => Some(LocationHint::EEur),
            Self::EBL => Some(LocationHint::EEur),
            Self::EVN => Some(LocationHint::EEur),
            Self::EWR => Some(LocationHint::Sam),
            Self::EZE => Some(LocationHint::Sam),
            Self::FCO => Some(LocationHint::EEur),
            Self::FIH => Some(LocationHint::WEur),
            Self::FLN => Some(LocationHint::ENam),
            Self::FOC => None,
            Self::FOR => Some(LocationHint::WEur),
            Self::FRA => Some(LocationHint::EEur),
            Self::FRU => Some(LocationHint::Afr),
            Self::FSD => Some(LocationHint::WNam),
            Self::FUK => Some(LocationHint::Apac),
            Self::FUO => None,
            Self::GBE => Some(LocationHint::WEur),
            Self::GDL => Some(LocationHint::WNam),
            Self::GEO => Some(LocationHint::Sam),
            Self::GIG => Some(LocationHint::Sam),
            Self::GND => Some(LocationHint::ENam),
            Self::GOT => Some(LocationHint::WEur),
            Self::GRU => Some(LocationHint::Sam),
            Self::GUA => Some(LocationHint::Sam),
            Self::GUM => Some(LocationHint::WNam),
            Self::GVA => Some(LocationHint::Afr),
            Self::GYD => Some(LocationHint::Afr),
            Self::GYE => Some(LocationHint::Sam),
            Self::GYN => Some(LocationHint::Sam),
            Self::HAK => None,
            Self::HAM => Some(LocationHint::Afr),
            Self::HAN => Some(LocationHint::Apac),
            Self::HBA => Some(LocationHint::Oc),
            Self::HEL => Some(LocationHint::EEur),
            Self::HFA => Some(LocationHint::WEur),
            Self::HGH => None,
            Self::HKG => Some(LocationHint::Apac),
            Self::HNL => Some(LocationHint::WNam),
            Self::HRE => Some(LocationHint::WEur),
            Self::HYD => Some(LocationHint::Oc),
            Self::HYN => None,
            ...
            Self::PHL => Some(LocationHint::ENam),
            ...
            Self::RAO => Some(LocationHint::Sam),
            Self::RDU => Some(LocationHint::ENam),
            Self::REC => Some(LocationHint::Sam),
            Self::RIC => Some(LocationHint::ENam),
            Self::RIX => Some(LocationHint::EEur),
            Self::RUH => Some(LocationHint::WEur),
            ...
            Self::SJU => Some(LocationHint::ENam),
            Self::SJW => None,
            Self::SKG => Some(LocationHint::EEur),
            Self::SKP => Some(LocationHint::Me),
            ...
            Self::SSA => Some(LocationHint::ENam),
            Self::STI => Some(LocationHint::ENam),
            Self::STL => Some(LocationHint::Sam),
            Self::STR => Some(LocationHint::WEur),
            ...
            Self::TNA => None,
            Self::TNR => Some(LocationHint::Afr),
            Self::TPA => Some(LocationHint::ENam),
            Self::TPE => Some(LocationHint::Apac),
            Self::TUN => Some(LocationHint::Afr),
            Self::TXL => Some(LocationHint::Me),
            Self::TYN => None,
            Self::UDI => Some(LocationHint::Sam),
            Self::UDR => Some(LocationHint::Apac),
            ...
            Self::VIX => Some(LocationHint::ENam),
            Self::VNO => Some(LocationHint::Me),
            Self::VTE => None,
            Self::WAW => Some(LocationHint::Me),
            Self::WDH => Some(LocationHint::Afr),
            Self::WLG => Some(LocationHint::Oc),
            Self::WRO => Some(LocationHint::Me),
            Self::XAP => Some(LocationHint::ENam),
            Self::XFN => None,
            Self::XIY => None,
            Self::XNH => Some(LocationHint::Me),
            Self::YHZ => Some(LocationHint::ENam),
            Self::YUL => Some(LocationHint::Sam),
            Self::YVR => Some(LocationHint::WNam),
            Self::YWG => Some(LocationHint::ENam),
            Self::YXE => Some(LocationHint::WNam),
            Self::YYC => Some(LocationHint::WNam),
            Self::YYZ => Some(LocationHint::ENam),
            Self::ZAG => Some(LocationHint::EEur),
