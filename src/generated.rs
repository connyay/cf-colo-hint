...
impl Colo {
    ...
    pub const fn location_hint(&self) -> Option<LocationHint> {
        match self {
            ...
            Self::AIP => Some(LocationHint::Apac),
            ...
            Self::HFA => Some(LocationHint::Afr),
            Self::HGH => None,
            ...
            Self::MBA => Some(LocationHint::WEur),
