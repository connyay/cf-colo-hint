...
impl Colo {
    ...
    pub const fn location_hint(&self) -> Option<LocationHint> {
        match self {
            ...
            Self::BSB => Some(LocationHint::WNam),
            ...
            Self::HYN => None,
            Self::IAD => Some(LocationHint::WNam),
            ...
            Self::MAO => Some(LocationHint::WEur),
            ...
            Self::RIC => Some(LocationHint::WNam),
            ...
            Self::SCL => Some(LocationHint::WNam),
